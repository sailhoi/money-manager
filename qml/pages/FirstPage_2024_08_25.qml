...
//        contentHeight: column.height
        ...
        PullDownMenu {
            ...
            MenuItem {
                text: qsTr("Add")
                onClicked: {
                    onClicked: pageStack.push(Qt.resolvedUrl("EditTransationPage.qml"))
                }
            }
        }
            ...
            Column {
                ...
                ListView {
                    ...
                    delegate: ListItem {
                        ...
                        onClicked: {
                            if (!menu.visible && pageStack.depth == 2) {
                                pageStack.animatorPush(Qt.resolvedUrl("EditTransactionPage.qml"))
                            }
                        }
                        ...
                        menu: ContextMenu {
                            ...
                            MenuItem {
                                text: "Delete"
                                onClicked: {
                                    DB.deleteTransaction(model.uniqueId);
